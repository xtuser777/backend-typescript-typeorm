...
//     const type: TruckType = { id: 0, ...req.body.type };

//     const model = new TruckTypeModel(type);
...
//     }
//     type.toAttributes.description = req.body.type.description;
//     type.toAttributes.axes = req.body.type.axes;
//     type.toAttributes.capacity = req.body.type.capacity;
